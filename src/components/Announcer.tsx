 ...
 * section 7.1 as a measure applied uniformly across all portals, and that was
 * the half already built. The other half is the same message on screen.
 *
 * Having only the first was a real hole, and a worse one here than anywhere
 * else in the system. A student uploads a disability certificate; the file
 * input clears and the document appears further down a list they may not have
 * scrolled to. A screen-reader user was told it worked. Everybody else was left
 * to guess — and this is an audience the report describes as abandoning at the
 * first sign that a form has not understood them.
 *
...
/* Longer than the admin panel's ten seconds. The same sentence takes
 * longer to read at this type size, longer again through a screen
 * magnifier, and longer still for somebody reading their second language. */
const DISMISS_AFTER = 14_000
